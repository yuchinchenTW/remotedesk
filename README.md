...
- On single-monitor hosts with `ffmpeg.exe` next to the app, it now prefers a higher-quality H.264 RGB stream over MPEG-TS, with a higher capture-size ceiling for better zoom clarity.
